...
key2 = pwn.xor(bytes.fromhex(key1_2), key1)
key3 = pwn.xor(bytes.fromhex(key2_3), key2)
# xor(a,b), xors the value a with b. Comes with pwntool lib


key1_2_3 = pwn.xor(bytes.fromhex(key1_2), key3)


flag = pwn.xor(bytes.fromhex(flag_key123), key1_2_3)
